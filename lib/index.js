...
var Koahub = function () {
    ...
    (0, _createClass3.default)(Koahub, [{
        ...
        value: function runWatcher() {
            ...
            // 主进程监控
            new _watcher2.default(koahub.paths);
        }
    }, {
        key: "runCluster",
        value: function runCluster() {
            var clusterOnCPUs = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
        ...
        value: function start(port) {
            ...
            if (koahub.config('debug')) {
                koahub.log(_safe2.default.red('worker ' + process.pid + ' started'));
            }
