...
var Koahub = function () {
    ...
    (0, _createClass3.default)(Koahub, [{
        ...
        value: function loadPaths() {
            ...
            var root = this.options.root || process.env.ROOT || process.cwd();
            var app = _path2.default.resolve(root, this.options.app || process.env.APP || 'app');
        ...
        value: function loadConfigs() {
            ...
            koahub.configs = new _loader2.default(koahub.paths.app, _default2.default.loader.configs);
        ...
        value: function loadLoaders() {
            ...
            for (var key in koahub.config('loader')) {
                ...
                koahub[key] = new _loader2.default(koahub.paths.app, koahub.config('loader')[key]);
            }
        ...
        value: function loadMiddlewares() {
            ...
            if (koahub.config('logger')) {
                this.use((0, _koaLogger2.default)());
            }

            // favicon middleware
            if (koahub.config('favicon')) {
                if (_lodash2.default.isString(koahub.config('favicon'))) {
                    this.use((0, _koaFavicon2.default)(koahub.config('favicon')));
                } else {
            ...
            if (koahub.config('cors')) {
                if (_lodash2.default.isPlainObject(koahub.config('cors'))) {
                    this.use((0, _koaCors2.default)(koahub.config('cors')));
                } else {
                    if (_lodash2.default.isBoolean(koahub.config('cors'))) {
                        this.use((0, _koaCors2.default)());
                    } else {
            ...
            if (koahub.config('session')) {
                if (_lodash2.default.isPlainObject(koahub.config('session'))) {
                    this.use((0, _koaSession2.default)(koahub.config('session')));
                } else {
                    if (_lodash2.default.isBoolean(koahub.config('session'))) {
            ...
            if (koahub.config('static')) {
                if (_lodash2.default.isPlainObject(koahub.config('static'))) {
                    ...
                    this.use((0, _koaStaticCache2.default)(dir, options));
                } else {
        ...
        value: function use(fn) {
            ...
            if ((0, _default3.isGeneratorFunction)(fn)) {
                fn = (0, _koaConvert2.default)(fn);
            }
            this.koa.use(fn);
        }
        ...
        key: "useExpress",
        value: function useExpress(fn) {

            fn = (0, _default3.expressMiddlewareToKoaMiddleware)(fn);
            this.koa.use(fn);
        }
        ...
        value: function getServer() {
            ...
            var server = _http2.default.Server(this.koa.callback());
        ...
        value: function loadHttpMiddlewares() {
            ...
            if (koahub.config('body')) {
                if (_lodash2.default.isPlainObject(koahub.config('body'))) {
                    ...
                    this.use((0, _koaBody2.default)(koahub.config('body')));
                    this.use(function () {
            ...
            // 加载http中间件
            this.use((0, _http4.default)().skip(function (ctx) {
