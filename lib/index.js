...
var Koahub = function () {
    ...
    (0, _createClass3.default)(Koahub, [{
        ...
        key: "loader",
        value: function loader(name, options) {
             ...
             */
            koahub[name] = new _loader2.default(options);
        }
    }, {
        key: "run",
        ...
        value: function started(port) {
            ...
            koahub.log(_safe2.default.green("Server Cluster Status: " + koahub.config('cluster_on')));
            koahub.log(_safe2.default.green("Server Debug Status: " + koahub.config('debug')));
            koahub.log(_safe2.default.green("Server File Watcher: " + koahub.config('watcher_on')));
