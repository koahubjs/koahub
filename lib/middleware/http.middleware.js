...
function httpMiddleware() {
    ...
    var http = function () {
        var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(ctx, next) {
            var routers, regexp, regres, index, url, path, method, params, keys, router, key, _router, routerMethod;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            regexp = void 0, regres = void 0, index = void 0, url = void 0, path = void 0, method = ctx.method, params = [], keys = [];
                        ...
                        case 4:
                            ...
                            regexp = (0, _pathToRegexp2.default)(routers[router][0], keys, { strict: true });
