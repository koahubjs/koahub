...
var Controller = function () {
    function Controller(ctx, next) {
        ...
        (0, _assert2.default)(ctx, 'SyntaxError: missing super(ctx) call in constructor');
        (0, _assert2.default)(next, 'SyntaxError: missing super(next) call in constructor');

        this.ctx = ctx;
        this.next = next;
        this.hook = new _hook2.default(ctx, next);
        ...
        var _loop = function _loop(name) {
            if (typeof ctx[name] !== 'function') {
                ...
                if ((0, _default.isGeneratorFunction)(ctx[name])) {
                    _this[name] = _co2.default.wrap(ctx[name]).bind(ctx);
                } else {
                    _this[name] = ctx[name];
                }
            }
