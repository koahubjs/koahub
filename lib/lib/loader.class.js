...
var _class = function () {
    function _class(runtimePath, options) {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        value: function walk(dir) {
            ...
            dir = _path2.default.resolve(this.runtimePath, dir);
        ...
        value: function loader(options) {
            ...
            var _loop = function _loop(key) {
                ...
                var name = _path2.default.relative(_path2.default.resolve(_this.runtimePath, options.root), paths[key]);
