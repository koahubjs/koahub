        ...
        value: function walk(dir) {
            ...
            try {
                for (var _iterator2 = (0, _getIterator3.default)(files), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (_fs2.default.statSync(_path3.default.resolve(dir, file)).isDirectory()) {
                        list = list.concat(this.walk(_path3.default.resolve(dir, file)));
                    } else {
                        list.push(_path3.default.resolve(dir, file));
                    }
                }
            } catch (err) {
