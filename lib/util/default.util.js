...
function getModuleControllerAction(path) {
    ...
    var module = koahub.configs.default.default_module;
    var controller = koahub.configs.default.default_controller;
    var action = koahub.configs.default.default_action;
