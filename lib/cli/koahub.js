        ...
        var _ret = function () {
            var startRuntimeProcess = function startRuntimeProcess(runtimeFile) {
                ...
                runtimeProcess.on('exit', function (code) {
                    if (code == _exit.EXITCODE.EADDRINUSE) {
                        process.exit(_exit.EXITCODE.NORMAL);
                    }

                    if (code == _exit.EXITCODE.NORMAL) {
            ...
            process.on('SIGINT', function () {
                ...
                process.exit(_exit.EXITCODE.SIGINT);
            });
            ...
            var files = [];
            // 开启文件监控
            (0, _watcher2.default)(function (filePath) {
