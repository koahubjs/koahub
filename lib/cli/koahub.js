...
_commander2.default.command('controller [name]').description('koahub create controller template').action(function (name) {

    var templatePath = './node_modules/koahubjs/template';

    try {
        fileCopy(_path2.default.resolve(templatePath, 'controller/index.controller.js'), _path2.default.resolve(_index2.default.app, "controllers/" + name + ".controller.js"));
    } catch (err) {
